...
from pyfivetran.endpoints.base import Endpoint, Client, Response, ApiError
...
class TestEndpoint:
    ...
    def test_pagination_fixed(self, mocker):
        ...
        first_response_mock.json.return_value = {'data': 'example', 'next_cursor': '123'}
        ...
        assert responses == [first_response_mock, first_response_mock, next_response_mock]
